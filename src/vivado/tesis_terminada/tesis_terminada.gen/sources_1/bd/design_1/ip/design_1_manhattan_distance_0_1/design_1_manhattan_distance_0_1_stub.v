...
// Command     : write_verilog -force -mode synth_stub -rename_top design_1_manhattan_distance_0_1 -prefix
//               design_1_manhattan_distance_0_1_ design_1_manhattan_distance_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_manhattan_distance_0_0,manhattan_distance,{}" *) (* CORE_GENERATION_INFO = "design_1_manhattan_distance_0_0,manhattan_distance,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=manhattan_distance,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,WIDTH=16}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "package_project" *) (* X_CORE_INFO = "manhattan_distance,Vivado 2025.1" *) 
module design_1_manhattan_distance_0_1(clk, ena, prl_sample, prh_sample, prl_test, 
