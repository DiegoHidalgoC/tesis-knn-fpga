...
HD_PWD='C:/Users/diego/OneDrive/Escritorio/tesis_de_mierda/tesis_de_mierda.runs/design_1_sample_packer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sample_packer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sample_packer_0_0.tcl
