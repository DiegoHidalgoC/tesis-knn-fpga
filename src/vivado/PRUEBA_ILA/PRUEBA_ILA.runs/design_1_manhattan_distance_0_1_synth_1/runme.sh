...
HD_PWD='C:/Users/diego/OneDrive/Escritorio/PRUEBA_ILA/PRUEBA_ILA.runs/design_1_manhattan_distance_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_manhattan_distance_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_manhattan_distance_0_1.tcl
